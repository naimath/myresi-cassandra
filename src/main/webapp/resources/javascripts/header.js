        ...
        validators: {
            badWordsValidator: function (el, required, parent) {
                ...
                if ($.inArray(el.value, badwords) > -1) {
                    ...
                    $(parent).children('small').html("Hey!! You cannot use that word.");
                    return false;
                }else{
                    $(parent).children('small').html("Please enter a valid email address.");
                }
                return true;
            }
        }
...
/*
 Ajax To Validate and POST the Login Form.
 * */
$('#loginForm')
    .on('invalid.fndtn.abide', function () {
        return false;
...
/*
  Ajax To Validate and POST the Contact Form.
 * */
...
/*
 END Ajax To Validate and POST the Contact Form.
 * */
