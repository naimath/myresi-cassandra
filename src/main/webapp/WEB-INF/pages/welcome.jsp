                ...
                <hr/>
                    ...
                    <ul class="large-block-grid-2">
                        ...
                        <li>
                            ...
                            <div class="large-12 columns radius" style="background-color: #F9F9F9">
                                ...
                                <div class="large-6 columns text-right" style="padding-top: 1rem">
                                    <button class="button radius small right">Read More</button>
                                </div>

                                <hr/>

                                <p class="large-12 columns">
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus fringilla odio sem, at faucibus felis consectetur sed.
                                    Proin a ex volutpat, iaculis ligula id, imperdiet turpis. Pellentesque id tellus diam. Suspendisse vel nisl ultrices,
                                    ornare dolor sed, convallis tellus. Suspendisse convallis semper iaculis. Sed eget sapien vitae justo sodales cursus.
                                    Sed iaculis vitae erat quis egestas. Proin laoreet congue leo placerat egestas. Donec ante quam, dictum vitae augue non,
                                    molestie pretium justo. Donec tincidunt id quam a tincidunt. Nulla ultrices faucibus justo. Suspendisse potenti.
                                </p>
